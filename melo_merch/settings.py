...
ALLOWED_HOSTS = ['melo-merch.herokuapp.com', 'localhost']
...
# just in case because of gitpod
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'melo-merch'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'melomerch@example.com'
else:
